...
module.exports = new HackScraper();
...
function updateAfterResult(userId, win, outcome, isSkip, level) {
    initUser(userId);
    const state = userStates[userId];
    if (!state.predictionOutcomes) state.predictionOutcomes = [];
