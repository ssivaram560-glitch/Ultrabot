...
function updateAfterResult(userId, wasWin, actual, betPlaced) {
    ...
    // Change prediction mode after every settled result:
    // NORMAL = BIG/SMALL (SIZE), RECOVERY = COLOUR.
    // Both WIN and LOSS move to the opposite mode for the next prediction.
